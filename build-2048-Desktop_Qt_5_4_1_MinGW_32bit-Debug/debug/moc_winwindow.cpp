...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_winwindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_winwindow_t qt_meta_stringdata_winwindow = {
    {
QT_MOC_LITERAL(0, 0, 9), // "winwindow"
QT_MOC_LITERAL(1, 10, 10), // "keep_going"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8), // "new_game"
QT_MOC_LITERAL(4, 31, 26), // "on_keepgoingButton_clicked"
QT_MOC_LITERAL(5, 58, 24) // "on_newgameButton_clicked"

    },
    "winwindow\0keep_going\0\0new_game\0"
...
void winwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&winwindow::keep_going)) {
                *result = 0;
            }
        }
        {
            typedef void (winwindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&winwindow::new_game)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject winwindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_winwindow.data,
...
void *winwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_winwindow.stringdata))
...
// SIGNAL 0
void winwindow::keep_going()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void winwindow::new_game()
{
